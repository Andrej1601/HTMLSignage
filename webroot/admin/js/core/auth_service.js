...
const DEFAULT_PERMISSIONS = ['cockpit', 'slides', 'slides-flow', 'slides-automation', 'slides-overview', 'saunas', 'media', 'footnotes', 'badges', 'global-info', 'colors', 'system', 'devices', 'user-admin'];
