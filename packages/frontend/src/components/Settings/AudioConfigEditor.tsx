                ...
                <div className="space-y-2">
                  ...
                  {audioItems.length === 0 ? (
                    ...
                    <select
                      ...
                      className="w-full px-3 py-2.5 border border-stone-200 rounded-lg text-sm focus:ring-2 focus:ring-[#8B6F47]/20 focus:border-[#8B6F47] outline-none bg-stone-50"
                    >
        ...
        <div className="space-y-6">
          ...
          <div className="bg-stone-900 rounded-xl p-6 relative overflow-hidden">
            ...
            <div className="relative z-10 flex items-start justify-between">
              <div className="space-y-3">
                <div className="w-11 h-11 bg-white/10 rounded-xl flex items-center justify-center backdrop-blur-sm text-xl">
                  🎵
                </div>
                <div>
