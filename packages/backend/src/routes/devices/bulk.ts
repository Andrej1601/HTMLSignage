...
router.patch('/bulk/update', authMiddleware, requirePermission('devices:manage'), mutationLimiter, asyncHandler(async (req: AuthRequest, res) => {
...
router.post('/bulk/control', authMiddleware, requirePermission('devices:manage'), mutationLimiter, asyncHandler(async (req: AuthRequest, res) => {
