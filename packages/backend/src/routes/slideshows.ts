...
router.get('/', authMiddleware, requirePermission('slideshow:manage'), asyncHandler(async (req: AuthRequest, res) => {
...
router.get('/:id', authMiddleware, requirePermission('slideshow:manage'), asyncHandler(async (req: AuthRequest, res) => {
...
router.post('/', authMiddleware, requirePermission('slideshow:manage'), mutationLimiter, asyncHandler(async (req: AuthRequest, res) => {
...
router.patch('/:id', authMiddleware, requirePermission('slideshow:manage'), mutationLimiter, asyncHandler(async (req: AuthRequest, res) => {
...
router.delete('/:id', authMiddleware, requirePermission('slideshow:manage'), mutationLimiter, asyncHandler(async (req: AuthRequest, res) => {
