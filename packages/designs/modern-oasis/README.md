# @htmlsignage/design-modern-oasis

Modern Oasis — design pack for HTMLSignage.
...
3. Run `pnpm -F @htmlsignage/design-modern-oasis test` to verify the contract.
...
export const DESIGN_REGISTRY: Record<DesignId, () => Promise<Design>> = {
  ...
  'modern-oasis': () =>
    import('@htmlsignage/design-modern-oasis').then((m) => m.modernOasisDesign),
};
```
