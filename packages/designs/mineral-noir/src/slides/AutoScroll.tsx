...
/**
 * Vertical auto-scroll container: scrolls overflowing content up and
 * down in a loop, static when content fits. Uses rAF + transform, no
 * framer-motion dep. The inner container is observed via ResizeObserver
 * so content/container changes restart the cycle with new bounds.
 */
